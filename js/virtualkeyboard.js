  ...
  var _btnClick_ = function (e) { 
    ...
    */
    ...
    switch (el.id.substring(idPrefix.length)) {
      ...
      case "alt_left": break;
      case "alt_right": break;
      case "ctrl_left": return;
      case "ctrl_right":
          return;
    }
    ...
    */
    ...
    switch (key) {
      ...
      case "alt_left": 
      									if(change){
      										change = false;
      										self.switchLayout('KR 2 Beolsik'); 
      									}else{
      										change = true;
      										self.switchLayout('AL Albanian'); 
      									}	
      									break;
      case "alt_right": 
      									if(change){
  ...
  ;(function() {
      ...
      */
      ...
      nodes.keyboard.innerHTML =("<div id=\"kbDesk\"><!-- --></div>"
                                ...
                                //+"<select display="hidid=\"kb_langselector\"></select>"
